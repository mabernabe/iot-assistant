...
M5AtomS3SensorSettings m5AtomSensorSettings(PUBLISH_MEASURE_1_MINUTE_INTERVAL, LED_ACTIVE, LCD_INACTIVE);
...
void setup(){
 ...
 m5AtomS3Sensor.addGPIOMeasureSettings(getGPIOMeasureSettings(ESP_GPIO_NUM_1, DIGITAL_DUAL_BUTTON_A));
 m5AtomS3Sensor.addGPIOMeasureSettings(getGPIOMeasureSettings(ESP_GPIO_NUM_2, DIGITAL_DUAL_BUTTON_B));
}
