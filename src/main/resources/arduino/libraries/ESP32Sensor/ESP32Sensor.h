...
private:
	static bool shouldPublishChange(DigitalPropertyMeasured propertyMeasured, bool lastValue, bool newValue);
	static bool getDigitalMeasure(DigitalPropertyMeasured propertyMeasured);
