...
void ESP32Sensor::addGPIOMeasureSettings(DigitalGPIOMeasureSettings gpioMeasureSettings) {
	CallbackDigitalMeasureSetting callbackMeasuresSettings;
	callbackMeasuresSettings.propertyMeasured = gpioMeasureSettings.propertyMeasured;
	callbackMeasuresSettings.shouldPublishChangeCallback = this->shouldPublishChangeCallback;
	callbackMeasuresSettings.getMeasureCallback = this->getDigitalMeasureCallback;
	...
	this->addCallbackMeasureSettings(callbackMeasuresSettings);
}

void ESP32Sensor::addGPIOMeasureSettings(AnalogGPIOMeasureSettings gpioMeasureSettings) {
	CallbackAnalogMeasureSetting callbackMeasuresSettings;
	callbackMeasuresSettings.propertyMeasured = gpioMeasureSettings.propertyMeasured;
	callbackMeasuresSettings.shouldPublishChangeCallback = gpioMeasureSettings.shouldPublishChangeCallback;
	callbackMeasuresSettings.getMeasureCallback = this->getAnalogMeasureCallback;
	analogGPIOMeasuresSettings[analogGPIOMeasuresSettingsCount] = gpioMeasureSettings;
	analogGPIOMeasuresSettingsCount++;
	this->addCallbackMeasureSettings(callbackMeasuresSettings);
}

bool ESP32Sensor::shouldPublishChangeCallback(DigitalPropertyMeasured propertyMeasured, bool lastValue, bool newValue) {
...
bool ESP32Sensor::getDigitalMeasureCallback(DigitalPropertyMeasured propertyMeasured) {
	DigitalGPIOMeasureSettings gpioMeasureSetting = ESP32Sensor::getGpioMeasureSetting(propertyMeasured);
...
String ESP32Sensor::getAnalogMeasureCallback(AnalogPropertyMeasured propertyMeasured) {
...
void ESP32Sensor::postLoop(bool published, Measure measure) {
	if (this->esp32SensorSettings->isDeepSleepEnabled() && published)  {
...
void ESP32Sensor::deepSleep(Measure measure) {
	...
	esp_sleep_enable_timer_wakeup(publishInterval);
