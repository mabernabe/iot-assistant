var restAPIService = angular.module('restAPIService', ['restLocationService', 'ngResource']);

restAPIService.config(function($resourceProvider) { 
	$resourceProvider.defaults.stripTrailingSlashes = false; 
})

restAPIService.service ("RestAPIService",function(RestLocationService, $q, $resource){
	var self = this;	
